...
func IDEqualFold(id string) predicate.Listener {
	return predicate.Listener(sql.FieldEqualFold(FieldID, id))
}

// IDContainsFold applies the ContainsFold predicate on the ID field.
func IDContainsFold(id string) predicate.Listener {
	return predicate.Listener(sql.FieldContainsFold(FieldID, id))
}
